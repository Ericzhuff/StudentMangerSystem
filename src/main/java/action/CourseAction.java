...
public class CourseAction extends ActionSupport implements Preparable{
	...
	public void prepare() throws Exception {
		if(id == null ||id.equals("")) {
			...
			course.setDate(sdf.format(new Date()));
		}else {
	...
	@Action(value="view",results = {
            @Result(name = "success", location = "/admin/page/course/courseView.jsp")})
	public String view() {
		return "success";
	}
	...
	@Action(value="findTopTen",results= {@Result(name = "findTopTen",type="json",params= {"root","courseList"})})
	public String findTopTen() {
		courseList = courseService.findCourseTopTen();
		return "findTopTen";
	}

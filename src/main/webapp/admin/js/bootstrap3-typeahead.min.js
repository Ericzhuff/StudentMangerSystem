! function (a, b) {
    ...
    b.prototype = {
        ...
        setDefault: function (a) {
            ...
            if (this.query = void 0 !== b && null !== b ? b : this.$element.val(), this.query.length < this.options.minLength && !this.options.showHintOnFocus) return this.shown ? this.hide() : this;
            ...
            return a.each(b, function (a, c) {
                ...
                if ("category" == (f.__type || !1)) return a(c.options.headerHtml || c.theme.headerHtml).text(f.name)[0];
                if ("divider" == (f.__type || !1)) return a(c.options.headerDivider || c.theme.headerDivider)[0];
                var g = d.displayText(f);
                return b = a(c.options.item || c.theme.item).data("value", f), b.find(c.options.itemContentSelector || c.theme.itemContentSelector).addBack(c.options.itemContentSelector || c.theme.itemContentSelector).html(c.highlighter(g, f)), c.options.followLinkOnSelect && b.find("a").attr("href", d.itemLink(f)), b.find("a").attr("title", d.itemTitle(f)), g == d.$element.val() && (b.addClass("active"), d.$element.data("active", f), e = !0), b[0]
            ...
            var c = this.$menu.find(".active").removeClass("active"),
                d = c.next();
            d.length || (d = a(this.$menu.find(a(this.options.item || this.theme.item).prop("tagName"))[0])), d.addClass("active");
            var e = this.updater(d.data("value"));
            this.$element.val(this.displayText(e) || e)
        }, prev: function (b) {
            var c = this.$menu.find(".active").removeClass("active"),
                d = c.prev();
            d.length || (d = this.$menu.find(a(this.options.item || this.theme.item).prop("tagName")).last()), d.addClass("active");
            var e = this.updater(d.data("value"));
            this.$element.val(this.displayText(e) || e)
        }, listen: function () {
            ...
            17 !== b.keyCode && (this.keyPressed = !0, this.suppressKeyPressRepeat = ~a.inArray(b.keyCode, [40, 38, 9, 13, 27]), this.shown || 40 != b.keyCode ? this.move(b) : this.lookup())
        }, keypress: function (a) {
            ...
            this.mousedover || this.mouseddown || !this.shown ? this.mouseddown && (this.skipShowHintOnFocus = !0, this.$element.focus(), this.mouseddown = !1) : (this.select(), this.hide(), this.focused = !1, this.keyPressed = !1)
        }, click: function (a) {
    ...
    a.fn.typeahead = function (c) {
        ...
        themes: {
            bootstrap3: {
                menu: '<ul class="layui-anim layui-anim-upbit typeahead dropdown-menu" role="listbox"></ul>',

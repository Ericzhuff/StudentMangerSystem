...
layui.config({
	...
	function showNotice(){
		layer.open({
	        ...
	        content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;"><p>这是一套学生信息管理系统，分为两个功能:<p>其一使用超级管理员的身份登录，可以对学生，课程等信息进行管理，并且可以对系统进行一些设置；</p><p>其二，使用学生的身份登录，可以进行选课以及对自己所选课程进行查看等功能。</p><p>本程序功能有待完善，欢迎大家指出程序不足。</p><p>QQ：644235159</p></div>',

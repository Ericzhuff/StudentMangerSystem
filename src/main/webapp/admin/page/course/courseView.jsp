	...
	<div class="course_left">
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" class="layui-input newsName" value="<s:property value='course.course_id' />" lay-verify="required" placeholder="请输入课程编号" name="course.course_id" readonly>
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label">课程名称</label>
			<div class="layui-input-block">
				<input type="text" class="layui-input newsName" lay-verify="required" value="<s:property value='course.course_name' />" placeholder="请输入课程名称" name="course.course_name" readonly>
			</div>
		</div>
		...
		<div class="layui-form-item layui-form-text">
    		...
    		<div class="layui-input-block">
      			<textarea  placeholder="请输入课程描述" class="layui-textarea" name="course.course_description" readonly><s:property value='course.course_description' /></textarea>
    		</div>
  		</div>
  		</div>

	...
	$.ajax({
		...
		"success":function(data){
			...
			for(var i= 0;i<data.length;i++){
				html+="<a href='"+href+"?id="+data[i].id+"&course_id="+data[i].course_id+"' class='studentList'><div class='grid-item'><img class='images' src='"+imagePath+data[i].image+"'><br>"+data[i].course_name+"<br>"+data[i].course_credits+"</div></a>"
			}
			$(".grid").append(html);
		}
	});

...
layui.config({
	...
	var layer = parent.layer === undefined ? layui.layer : parent.layer;
		...
		var basePath = $("body",window.parent.parent.parent.document).attr("basePath");
        if($("#image").val() != ""){
...
console.log($(".loginout"));
        ...
        var areaData;
 	$.ajax({
			url:basePath+"studentInfo/listForProvice",
			async : false,
			data:{"name":"省"},
			success:function(data){
				areaData = data;
 	...
 	function loadProvince() {
 	    ...
 	    if(address != ""){
		    ...
		    var count;
		    $.ajax({
				url:basePath+"studentInfo/listForSelect",
 	...
 	$.ajax({
		url:basePath+"dictionary/findMajor",
		async : false,
		success:function(data){

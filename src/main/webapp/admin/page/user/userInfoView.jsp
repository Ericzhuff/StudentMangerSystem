		...
		<div class="user_left">
			<div class="layui-form-item">
			    ...
			    <div class="layui-input-block">
			    	<input type="text" class="layui-input newsName" value="<s:property value='admin.name' />" lay-verify="required" placeholder="请输入用户名" name="admin.name" readonly>
			    </div>
			</div>
			<div class="layui-form-item">
			    <label class="layui-form-label">真实姓名</label>
			    <div class="layui-input-block">
			    	<input type="text" class="layui-input newsName" value="<s:property value='admin.realname' />" lay-verify="required" placeholder="请输入真实姓名" name="admin.realname" readonly>
			    </div>
			</div>
		<div class="layui-form-item unclicked">
			...
			<div class="layui-form-item">
			    ...
			    <div class="layui-input-block">
			    	<input type="text" class="layui-input newsName" value="<s:property value='admin.phonenum' />" lay-verify="required" placeholder="请输入手机号码" name="admin.phonenum" readonly>
			    </div>
			</div>
			<div class="layui-form-item">
			    <label class="layui-form-label">出生年月</label>
			    <div class="layui-input-block">
			    	<input type="text" value="<s:property value='admin.birthday' />" placeholder="请输入出生年月" lay-verify="required|date" onclick="layui.laydate({elem: this,max: laydate.now()})" class="layui-input" id="text1" readonly>
			    </div>
			</div>
			...
			<div class="layui-form-item">
			    ...
			    <div class="layui-input-block">
			    	<input type="text" value="<s:property value='admin.email' />" name="admin.email" placeholder="请输入邮箱" lay-verify="required|email" class="layui-input" readonly>
			    </div>
			</div>
			<div class="layui-form-item">
			    <label class="layui-form-label">自我评价</label>
			    <div class="layui-input-block">
			    	<textarea  placeholder="请输入自我评价" class="layui-textarea" name="admin.appraise" readonly><s:property value='admin.appraise' /></textarea>
			    </div>
			</div>
		</div>
